    ...
    <>
      <section className="service1-1 section">
        <div className="container">
          ...
          <h1 className="service1-1__title ">Решение в сфере IT</h1>
        </div>

        <div className="service1-1__img"><img src="/img/img2.png" alt="photo" /></div>
        <div className="container">
          ...
          <ul className="service1-1__list2">
            <li className="service1-1__item">Биометрический учет рабочего времени</li>
            <li className="service1-1__item">IT-решения в охране</li>
            <li className="service1-1__item">Аутсорс IT-услуг</li>
          </ul>
        </div>
      </section>
